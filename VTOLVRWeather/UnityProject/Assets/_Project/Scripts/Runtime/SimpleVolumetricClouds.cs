...
namespace DaftAppleGames.SimpleClouds
{
    public class SimpleVolumetricClouds : MonoBehaviour
    {
        ...
        void GenerateInitialNoise()
        {
            ...
            GetComponent<MeshFilter>().sharedMesh = HemispherePolarUvs.hemisphere;
            GetComponentsInChildren<MeshFilter>()[1].sharedMesh = HemispherePolarUvs.hemisphereInv;
            ...
            PlayerCamera.AddCommandBuffer(CameraEvent.BeforeImageEffects, cloudsCommBuff);
        }
        ...
        void CloudsUpdate()
        {
            cloudShadows.position = PlayerCamera.transform.position;
            ...
            skyMaterial.SetVector("_uWorldSpaceCameraPos", PlayerCamera.transform.position);
